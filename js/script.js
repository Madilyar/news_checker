...
function getAnalysisLabel(riskLevel) {
    switch (riskLevel) {
        ...
        // Додаємо точні рядки з Python
        case "Фейк / Дезінформація": // Рядок з Python для "Фейк / Дезінформація"
            return "Виявлено дезінформацію";
        case "Потребує перевірки (Клікбейт)": // Рядок з Python
            return "Потребує перевірки (Клікбейт)"; // Відповідний текст для відображення
        case "Потребує перевірки (Необ'єктивно)": // Рядок з Python
            return "Потребує перевірки (Необ'єктивно)"; // Відповідний текст для відображення
        default:
            return "Аналіз невідомий"; // Якщо отримано щось, чого немає в списку
    }
}
